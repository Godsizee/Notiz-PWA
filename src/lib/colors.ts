...
export const NOTE_COLORS = [
  ...
  { id: 'blue', label: 'Blau', hex: '#dbeafe' },
  { id: 'green', label: 'Grün', hex: '#dcfce7' },
  { id: 'yellow', label: 'Gelb', hex: '#fef9c3' },
  { id: 'pink', label: 'Rosa', hex: '#fce7f3' },
  { id: 'purple', label: 'Lila', hex: '#f3e8ff' },
...
export function getNoteColorStyles(color: string | undefined): NoteStyle {
  ...
  if (c === 'blue' || c === '#e3f2fd' || c === '#dbeafe' || c === 'var(--color-pastel-blue)') {
    return {
  ...
  if (c === 'green' || c === '#e8f5e9' || c === '#dcfce7' || c === 'var(--color-pastel-green)') {
    return {
  ...
  if (c === 'yellow' || c === '#fffde7' || c === '#fef9c3' || c === 'var(--color-pastel-yellow)') {
    return {
  ...
  if (c === 'pink' || c === '#fce4ec' || c === '#fce7f3' || c === 'var(--color-pastel-pink)') {
    return {
  ...
  if (c === 'purple' || c === '#f3e5f5' || c === '#f3e8ff' || c === 'var(--color-pastel-purple)') {
    return {
  ...
  if (c === 'orange' || c === '#fff3e0' || c === '#ffedd5' || c === 'var(--color-pastel-orange)') {
    return {
